...
export async function handleMcpPost(request: NextRequest, server: McpServer): Promise<NextResponse> {
...
export async function handleMcpGet(request: NextRequest): Promise<Response> {
