...
if (!apiKey || !secret) throw new Error('BINANCE_API_KEY / BINANCE_SECRET_KEY must be set in .env');

const credentials = { apiKey, secret };
const adapter = createExchangeAdapter('binance', 'SPOT');
...
console.log('verify-binance: SUCCESS');
